...
For more info, visit https://reactjs.org/link/mock-scheduler`);
  ...
  function TodoList({ user, todo1, todo2 }) {
    const checkbox1 = /* @__PURE__ */ import_react.default.createElement("input", {
      type: "checkbox",
      onClick: function() {
        todoItem1 = null;
      }
    });
    var todoItem1 = /* @__PURE__ */ import_react.default.createElement("span", {
      key: todo1,
      style: { display: "block" }
    }, checkbox1, todo1);
    const checkbox2 = /* @__PURE__ */ import_react.default.createElement("input", {
      type: "checkbox",
      onClick: function() {
        todoItem2 = null;
      }
    });
    var todoItem2 = /* @__PURE__ */ import_react.default.createElement("span", {
      key: todo2,
      style: { display: "block" }
    }, checkbox2, todo2);
    const [checkboxes, setCheckboxes] = (0, import_react.useState)([checkbox1, checkbox2]);
    const [todoItems, setTodoItems] = (0, import_react.useState)([todoItem1, todoItem2]);
    const [textInputValue, setTextInputValue] = (0, import_react.useState)("");
    var textInput = /* @__PURE__ */ import_react.default.createElement("input", {
    ...
    return /* @__PURE__ */ import_react.default.createElement(import_react.default.Fragment, null, /* @__PURE__ */ import_react.default.createElement("h1", null, user, "'s todo list"), todoItems, textInput, /* @__PURE__ */ import_react.default.createElement("button", {
      onClick: () => {
        const checkbox = /* @__PURE__ */ import_react.default.createElement("input", {
          type: "checkbox",
          onClick: function() {
            setTodoItems(todoItems.filter((x) => x !== todoItem));
          }
        });
        var todoItem = /* @__PURE__ */ import_react.default.createElement("span", {
          key: textInputValue,
          style: { display: "block" }
        }, checkbox, textInputValue);
        setCheckboxes([...checkboxes, checkbox]);
        setTodoItems([...todoItems, todoItem]);
      }
    }, "Add item"), /* @__PURE__ */ import_react.default.createElement("span", {
      style: { display: "block" }
    }, checkboxes.length, " items"));
  }
